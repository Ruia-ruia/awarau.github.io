...
This is my first time doing kernel exploit development - so I apologise for inevitable mistakes and misunderstandings!
...
## Exploitation
### Assumptions
- kernel v5.15 with the bug reintroduced (`io_ring_ctx` is not a viable target in in v5.12 as its issued from kmalloc-4k but I was playing around on v5.15 here).

...
### `userfaultfd`
A system call which enables a user to create a file descriptor for handling page faults in user space. 
...
### `msgsnd` and `msgrcv`
System calls which enable IPC along message queues. 
